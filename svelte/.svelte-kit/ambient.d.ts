...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__solana_wallet_adapter_react_ui: string;
	export const TERM_PROGRAM_VERSION: string;
	export const npm_package_devDependencies_concurrently: string;
	export const npm_package_dependencies__solana_wallet_adapter_phantom: string;
	...
	export const npm_package_dependencies__solana_wallet_adapter_react: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__solana_wallet_adapter_react_ui: string;
		TERM_PROGRAM_VERSION: string;
		npm_package_devDependencies_concurrently: string;
		npm_package_dependencies__solana_wallet_adapter_phantom: string;
		...
		NVM_BIN: string;
		npm_package_dependencies__solana_wallet_adapter_react: string;
